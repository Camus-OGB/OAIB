...
export const phases = [
  ...
  { icon: BookOpen, phase: "Phase 02", title: "Formation Fondamentale", desc: "Acces aux supports de cours, webinaires et modules de logique IA.", date: "" },
  { icon: Terminal, phase: "Phase 03", title: "Tours Preliminaires", desc: "Examen national de logique et code en ligne. Top 20% qualifie.", date: "" },
  { icon: MapPin, phase: "Phase 04", title: "Qualificatifs Regionaux", desc: "Evenements physiques a Cotonou, Porto-Novo, Parakou, et Bohicon.", date: "" },
  { icon: Trophy, phase: "Phase 05", title: "Finale Nationale", desc: "Hackathon de 24h a Cotonou et presentation devant jury international.", date: "" },
